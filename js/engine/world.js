...
export class World {
    ...
    spawnRobot(name, robotClass, teamId, programId, position) {
        ...
        const pos = position ?? vec2(this.rng.nextFloat(5, this.config.arenaWidth - 5), this.rng.nextFloat(5, this.config.arenaHeight - 5));
        const robot = {
            id,
            name,
            class: robotClass,
