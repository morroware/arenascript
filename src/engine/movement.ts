...
import type { ActionIntent, RobotState, Vec2 } from "../shared/types.js";
...
export function resolveMovement(world: World, robot: RobotState, action: ActionIntent | null): void {
...
export function applyMovement(world: World, robot: RobotState): void {
