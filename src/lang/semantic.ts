...
import type {
  ProgramNode, Statement, Expression, TypeAnnotation, FunctionDeclNode,
} from "./ast.js";
...
export class SemanticAnalyzer {
  ...
  private functions = new Map<string, FunctionDeclNode>();
  ...
  private validateStatements(stmts: Statement[]): void {
  ...
  private validateType(type: TypeAnnotation): void {
  ...
  private isResolvable(name: string): boolean {
